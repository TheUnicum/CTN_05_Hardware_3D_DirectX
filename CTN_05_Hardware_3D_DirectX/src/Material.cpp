...
modelPath(path.string())
{
	...
	Technique outline{ "Outline",Chan::main,false };
	{
			...
			mask.AddBindable(InputLayout::Resolve(gfx, vtxLayout, *VertexShader::Resolve(gfx, "ShaderBins\\Solid_VS.cso")));
		...
		}
		{
			...
			// TODO: better sub-layout generation tech for future consideration maybe
			draw.AddBindable(InputLayout::Resolve(gfx, vtxLayout, *VertexShader::Resolve(gfx, "ShaderBins\\Solid_VS.cso")));
