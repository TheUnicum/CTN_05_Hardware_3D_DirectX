...
TestCube::TestCube(Graphics& gfx, float size)
{
...

	{
		Technique shade("Shade");
		{
			...
			auto pvs = VertexShader::Resolve(gfx, "PhongDif_VS.cso"); // IMPORTAT: this is the old shader!!
			auto pvsbc = pvs->GetBytecode();
			only.AddBindable(std::move(pvs));

			only.AddBindable(PixelShader::Resolve(gfx, "PhongDif_PS.cso"));// IMPORTAT: this is the old shader!!
