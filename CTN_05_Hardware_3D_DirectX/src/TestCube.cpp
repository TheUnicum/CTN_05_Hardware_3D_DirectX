...
TestCube::TestCube(Graphics& gfx, float size)
{
...

	{
		Technique shade("Shade", Chan::main);
		{
			...
			auto pvs = VertexShader::Resolve(gfx, "ShaderBins\\ShadowTest_VS.cso");
			only.AddBindable(InputLayout::Resolve(gfx, model.vertices.GetLayout(), *pvs));
			only.AddBindable(std::move(pvs));

			only.AddBindable(PixelShader::Resolve(gfx, "ShaderBins\\ShadowTest_PS.cso"));
...

	{
		Technique outline("Outline", Chan::main);
		{
			...
			mask.AddBindable(InputLayout::Resolve(gfx, model.vertices.GetLayout(), *VertexShader::Resolve(gfx, "ShaderBins\\Solid_VS.cso")));
		...
		}
		{
			...
			// TODO: better sub-layout generation tech for future consideration maybe
			draw.AddBindable(InputLayout::Resolve(gfx, model.vertices.GetLayout(), *VertexShader::Resolve(gfx, "ShaderBins\\Solid_VS.cso")));
